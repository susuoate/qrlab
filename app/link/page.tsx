...
export const metadata: Metadata = {
  title: 'แปลงลิงก์เป็น QR Code ฟรี — ทำ URL เป็น QR Code ง่ายนิดเดียว ไม่หมดอายุ | QR lab',
  ...
  openGraph: {
    title: 'แปลงลิงก์เป็น QR Code ฟรี — ทำ URL เป็น QR Code ง่ายนิดเดียว | QR lab',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'แปลงลิงก์เป็น QR Code ฟรี — QR lab',
    }],
  },
};
