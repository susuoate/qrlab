...
export const metadata: Metadata = {
  title: 'สร้าง QR Code LINE ฟรี — ทำ QR Code LINE เพิ่มเพื่อน & LINE Official ง่ายๆ | QR lab',
  ...
  openGraph: {
    title: 'สร้าง QR Code LINE ฟรี — ทำ QR Code LINE เพิ่มเพื่อน & LINE OA | QR lab',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'สร้าง QR Code LINE ฟรี — QR lab',
    }],
  },
};
