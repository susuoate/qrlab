...
export const metadata: Metadata = {
  ...
  applicationName: 'QR Code Maker',
  title: 'QR Code Maker — ทำ QR Code ฟรี สร้าง QR Code ง่ายนิดเดียว ไม่มีวันหมดอายุ',
...
const jsonLd = {
  ...
  '@graph': [
    ...
    },
    {
      ...
      description: 'QR Code Maker — ทำ QR Code ฟรี & QR Code Generator สร้างง่ายนิดเดียว ไม่มีลายน้ำ ปรับแต่งสีและโลโก้ได้ตามต้องการ',
    },
    {
      '@type': 'HowTo',
    ...
    },
    {
      ...
      mainEntity: [
        ...
        {
          '@type': 'Question',
          name: 'สร้าง QR Code ลิงก์ Google Maps สำหรับหมุดร้านค้าหรือพิกัดบอกทางทำอย่างไร?',
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'เลือกแท็บ Google Maps แล้ววางลิงก์แชร์สถานที่จาก Google Maps หรือกรอกพิกัดละติจูด-ลองจิจูด ระบบจะแปลงเป็น QR Code สแกนแล้วเปิดแอปนำทางได้ทันที',
          },
        },
        {
          '@type': 'Question',
          name: 'สร้าง QR Code สำหรับเปิดดูไฟล์ PDF เมนูอาหาร หรือเอกสารออนไลน์ทำอย่างไร?',
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'เลือกแท็บ PDF และใส่ลิงก์ Google Drive หรือลิงก์ไฟล์ PDF ระบบมีระบบแปลงลิงก์ Google Drive อัตโนมัติให้เปิดดูไฟล์ได้ทันทีโดยไม่ต้องผ่านหน้าดาวน์โหลด',
          },
        },
      ],
    },
