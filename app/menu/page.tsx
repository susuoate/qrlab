...
export const metadata: Metadata = {
  title: 'สร้าง QR Code เมนูอาหาร ฟรี — ทำ QR Code ดูเมนู ติดโต๊ะร้านอาหาร ไม่หมดอายุ | QR lab',
  ...
  openGraph: {
    title: 'สร้าง QR Code เมนูอาหาร ฟรี — ทำ QR Code ดูเมนู ติดโต๊ะร้านอาหาร | QR lab',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'สร้าง QR Code เมนูอาหาร ฟรี — QR lab',
    }],
  },
};
