...
export const metadata: Metadata = {
  title: 'สร้าง QR Code ไม่มีลายน้ำ ฟรี — ไม่ติดโลโก้ ไม่จำกัดจำนวน คมชัด 100% | QR lab',
  ...
  openGraph: {
    title: 'สร้าง QR Code ไม่มีลายน้ำ ฟรี — ไม่ติดโลโก้ คมชัด 100% | QR lab',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'สร้าง QR Code ฟรี ไม่มีลายน้ำ — QR lab',
    }],
  },
};
