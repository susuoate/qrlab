...
export const metadata: Metadata = {
  title: 'สร้าง QR Code Google Form ฟรี — แปลงลิงก์ฟอร์ม แบบสอบถาม ส่งงาน ง่ายๆ | QR lab',
  ...
  openGraph: {
    title: 'สร้าง QR Code Google Form ฟรี — แปลงลิงก์ฟอร์ม แบบสอบถาม ง่ายๆ | QR lab',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'สร้าง QR Code Google Form ฟรี — QR lab',
    }],
  },
};
